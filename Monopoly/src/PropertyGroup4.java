...
public class PropertyGroup4 extends Properties {
...
//	private int property3Price;
	...
	public PropertyGroup4(String t, String p1n, int p1p, int l1, String p2n, int p2p, int l2, String p3n, int p3p, int l3) {
